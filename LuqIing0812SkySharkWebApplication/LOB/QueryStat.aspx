<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="QueryStat.aspx.cs" Inherits="LuqIing0812SkySharkWebApplication.LOB.QueryStat" %>
                    ...
                    <asp:WizardStep ID="WizardStep2" runat="server" Title="Query Ticket Status">
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtTicktNo" runat="server"></asp:TextBox></td>
                                <td></td>
                            </tr>
                            <tr>
                                <td></td>
