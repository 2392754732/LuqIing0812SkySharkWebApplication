<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="CancelRes.aspx.cs" Inherits="LuqIing0812SkySharkWebApplication.LOB.CancelRes" %>
     ...
     <form id="form1" runat="server">
        <asp:Menu ID="Menu1" runat="server" BackColor="#B5C7DE" DynamicHorizontalOffset="2" Font-Names="Verdana" Font-Size="0.8em" ForeColor="#284E98" Orientation="Horizontal" StaticSubMenuIndent="10px">
            ...
            <Items>
                ...
                <asp:MenuItem NavigateUrl="~/LOB/CancelRes.aspx" Text="Cancel Reservation" Value="Cancle Reservation" Selected="True"></asp:MenuItem>
        ...
        <div class="tabContents">
            <table>
                ...
                <tr>
                    <td></td>
                    <td>
                        <asp:Button ID="btnCT" runat="server" Text="Cancel Ticker" />
                    </td>
                    <td></td>
                </tr>
                <tr>
