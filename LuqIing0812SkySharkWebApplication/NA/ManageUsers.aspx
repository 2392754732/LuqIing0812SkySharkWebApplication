<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ManageUsers.aspx.cs" Inherits="LuqIing0812SkySharkWebApplication.NA.ManageUsers" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form id="form1" runat="server">
        <asp:Menu ID="Menu1" runat="server" BackColor="#F7F6F3" DynamicHorizontalOffset="2" Font-Names="Verdana" Font-Size="0.8em" ForeColor="#7C6F57" Orientation="Horizontal" StaticSubMenuIndent="10px">
            ...
            <Items>
                <asp:MenuItem Selected="True" Text="Manage Users" Value="Manage Users" NavigateUrl="~/NA/ManageDatebase.aspx"></asp:MenuItem>
        ...
        <div class="tabContents">
            <table>
                <tr>
                    <td colspan="2"><asp:Label ID="Label1" runat="server" Text="Manage User Account"></asp:Label></td>
                    <td></td>
                    <td></td>
                ...
                <tr>
                    <td>
                        <asp:Label ID="Label4" runat="server" Text="Confrim Password"></asp:Label>
                    </td>
                    <td>
                        <asp:TextBox ID="txtAddConfPassword" runat="server"></asp:TextBox>
                    </td>
                    <td></td>
                    <td></td>
                </tr>
