    ...
    public partial class AddFI : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@Origin", txtOrginPlace.Text.Trim());
                cmd.Parameters.AddWithValue("@Destination", txtDestianation.Text.Trim());
                ...
                cmd.Parameters.AddWithValue("@SeatsExec", Convert.ToInt32(txtNoSE.Text.Trim()));
                cmd.Parameters.AddWithValue("@SeatsBn", Convert.ToInt32(txtNoSB.Text.Trim()));
                cmd.Parameters.AddWithValue("@FareExec", Convert.ToInt32(txtECF.Text.Trim()));
                cmd.Parameters.AddWithValue("@FareBn", Convert.ToInt32(txtBCF.Text.Trim()));
